...
def opcion_1(manejador_carreras, manejador_facultades):
...
def opcion_2(manejador_facultades):
...
def opcion_3(manejador_carreras, manejador_facultades):
...
def main_menu():
    manejador_facultades = ManejadorFacultad(10)
    manejador_carreras = ManejadorCarrera(20)
